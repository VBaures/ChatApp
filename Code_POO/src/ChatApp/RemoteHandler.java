...
public class RemoteHandler extends Thread{
    ...
    public void notifyServer(){
        try {
            ...
            System.out.println("ID envoyé= "+Integer.toString(networkHandler.getAgent().getPseudoHandler().getMain_User().getID()));
     ...
     public void NotifyDisconnection(){
         try {
             ...
             connection.setRequestProperty("ID",Integer.toString(networkHandler.getAgent().getPseudoHandler().getMain_User().getID()));
             connection.setRequestProperty("pseudo", networkHandler.getAgent().getPseudoHandler().getMain_User().getPseudo().trim());
             System.out.println("Envoyé au server: " + "connected=false&ID=" + networkHandler.getAgent().getPseudoHandler().getMain_User().getID() + "&pseudo=" + networkHandler.getAgent().getPseudoHandler().getMain_User().getPseudo());
             connection.disconnect();
